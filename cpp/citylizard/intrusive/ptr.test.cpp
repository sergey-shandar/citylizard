...
BOOST_AUTO_TEST_CASE(ptr_test)
{
    ...
    T::ptr_test_b object_b;
    {
        ...
        */
        ...
        // up_cast
        // I::ptr<T::ptr_test_a> const ab = b.up_cast<T::ptr_test_a>();
        I::ptr<T::ptr_test_a> const ab = citylizard::cast::explicit_::value(b);
        BOOST_CHECK(ab.unwrap() == 0);
        I::ptr<T::ptr_test_b> fb = I::wrap(&object_b);
        BOOST_CHECK(object_b.counter == 1);
        I::ptr<T::ptr_test_a> fab = citylizard::cast::explicit_::value(fb);
...
{    
    ...
    T::ptr_test_a object;
    {
        ...
        I::ptr<T::ptr_test_a> a = citylizard::cast::explicit_::value(ra);
        BOOST_CHECK(object.counter == 2);
        a.reset();
        BOOST_CHECK(object.counter == 1);
        // assignment from ref.
        a = citylizard::cast::explicit_::value(ra);
        BOOST_CHECK(object.counter == 2);
        // swap with ref.
        // a.swap(ra);
        BOOST_CHECK(object.counter == 2);
