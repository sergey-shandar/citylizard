namespace CityLizard.Binary
{
    public static class B
    {
        ...
        public struct V
        {
            ...
            public static implicit operator V(ulong value)
            {
                return new V(value);
            }

            public static implicit operator ulong(V this_)
            {
                return this_.Value;
            }

            public static implicit operator uint(V this_)
            {
                return (uint)this_.Value;
            }

            public static implicit operator ushort(V this_)
            {
                return (ushort)this_.Value;
            }

            public static implicit operator byte(V this_)
            {
